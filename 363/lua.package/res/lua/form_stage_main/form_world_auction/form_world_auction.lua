...
function on_main_form_close(self)
  ...
  nx_execute("custom_sender", "custom_world_auction", 6)
  nx_destroy(self)
end
...
function update_auction_single(...)
  ...
  local item_amount = nx_int(arg[3])
  local bind = nx_int(arg[4])
  local price = nx_int(arg[5])
  local competer_name = nx_widestr(arg[6])
  local end_time = nx_double(arg[7])
  local game_client = nx_value("game_client")
  local client_player = game_client:GetPlayer()
