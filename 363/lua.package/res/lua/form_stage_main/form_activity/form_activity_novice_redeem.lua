...
function on_main_form_open(form)
  ...
  form.mltbox_1:Clear()
  form.mltbox_1:AddHtmlText(gui.TextManager:GetText("ui_power_newer_3"), -1)
  form.mltbox_2:Clear()
  form.mltbox_2:AddHtmlText(gui.TextManager:GetText("ui_power_redeem_1"), -1)
  form.mltbox_3:Clear()
  form.mltbox_3:AddHtmlText(gui.TextManager:GetText("ui_novice_redeem_tips"), -1)
...
function on_btn_buy_click(self)
  ...
  if res == "ok" then
    ...
    nx_execute("custom_sender", "custom_novice_redeem", count)
  end
end
...
function open_form(num)
  ...
  local form = nx_execute("util_gui", "util_get_form", "form_stage_main\\form_activity\\form_activity_novice_redeem", true, false)
...
function update_num(num)
  local form = nx_value("form_stage_main\\form_activity\\form_activity_novice_redeem")
