...
function on_main_form_open(form)
  ...
  if form.FirstInflag then
    local page_info = util_get_form("form_stage_main\\form_relation\\form_relation_guild\\form_guild_bank_info", true, false)
    if form:Add(page_info) then
      ...
      form:Show()
      nx_execute("form_stage_main\\form_relation\\form_relation_guild\\form_guild_bank_info", "on_main_form_open", page_info)
    end
    local page_distribute = util_get_form("form_stage_main\\form_relation\\form_relation_guild\\form_guild_bank_distribute", true, false)
    ...
    local page_event = util_get_form("form_stage_main\\form_relation\\form_relation_guild\\form_guild_bank_event", true, false)
...
function on_main_form_close(form)
  nx_destroy(form)
  nx_set_value("form_stage_main\\form_relation\\form_relation_guild\\form_guild_bank", nx_null())
end
...
function on_rbtn_checked_changed(rbtn)
  ...
  if tab == 1 then
    ...
    nx_execute("form_stage_main\\form_relation\\form_relation_guild\\form_guild_bank_info", "on_main_form_open", form.page_info)
    form.btn_cancel.Visible = true
  elseif tab == 2 then
    if not nx_is_valid(form.page_distribute) then
      local page_distribute = util_get_form("form_stage_main\\form_relation\\form_relation_guild\\form_guild_distribute", true, false)
      if form:Add(page_distribute) then
        form.page_distribute = page_distribute
    ...
    nx_execute("form_stage_main\\form_relation\\form_relation_guild\\form_guild_bank_distribute", "on_main_form_open", form.page_distribute)
  elseif tab == 3 then
    if not nx_is_valid(form.page_event) then
      local page_event = util_get_form("form_stage_main\\form_relation\\form_relation_guild\\form_guild_event", true, false)
      if form:Add(page_event) then
        form.page_event = page_event
    ...
    nx_execute("form_stage_main\\form_relation\\form_relation_guild\\form_guild_bank_event", "on_main_form_open", form.page_event)
  end
end
