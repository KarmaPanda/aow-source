...
function on_main_form_close(self)
  nx_gen_event(self, "filename_return", "cancel")
...
function ok_btn_click(self)
  ...
  nx_gen_event(form, "filename_return", "ok", path, nx_string(form.file_name_edit))
  form:Close()
end
function on_btn_cancel_click(btn)
  ...
  nx_gen_event(form, "filename_return", "cancel")
  form:Close()
end
...
function get_edit_path(form)
  ...
  if 1 == node.Mark then
    ...
    local path = dir .. nx_string(form.file_name_edit.Text) .. ".9ycs"
    return path
  end
end
