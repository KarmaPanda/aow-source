...
local FORM_ATTRIBUTE_MALL_KFZDZ = "form_stage_main\\form_attribute_mall\\form_attribute_shop_kfzdz"
local mall_id = 7
...
function on_main_form_open(form)
  show_exchange_info(form, mall_id)
end
function on_main_form_close(form)
  nx_destroy(form)
end
function open_form()
  local form = util_get_form(FORM_ATTRIBUTE_MALL_KFZDZ, true)
...
function close_form()
  local form = util_get_form(FORM_ATTRIBUTE_MALL_KFZDZ, false, false)
  if nx_is_valid(form) then
    form:Close()
  end
end
