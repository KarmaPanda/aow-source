...
local FORM_ATTRIBUTE_MALL_FWZ = "form_stage_main\\form_attribute_mall\\form_attribute_shop_fwz"
...
function open_form()
  local form = util_get_form(FORM_ATTRIBUTE_MALL_FWZ, true)
...
function close_form()
  local form = util_get_form(FORM_ATTRIBUTE_MALL_FWZ, false, false)
  if nx_is_valid(form) then
    form:Close()
  end
end
