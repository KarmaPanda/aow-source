...
local school_npc_id = {
  ...
  newmp_tszyb_001 = "school_tianshan"
}
  ...
  for i = strat_num, menu_num do
    ...
    if table.getn(menu_sub_table) == 2 then
      ...
      if not is_func_btn_menu(func_id) then
        ...
        if height_groupbox < menu_control:GetContentHeight() and 0 < num then
