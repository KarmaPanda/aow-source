...
local FORM_PATH = "form_stage_main\\form_die_new_school_fight"
...
function on_btn_relive_click(self)
  nx_execute(nx_current(), "show_ok_dialog", self.ParentForm, RELIVE_TYPE_NEW_SCHOOL_FIGHT, nx_int(0))
end
