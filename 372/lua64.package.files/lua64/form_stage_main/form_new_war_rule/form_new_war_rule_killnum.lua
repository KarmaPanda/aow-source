local FORM_KILLNUM = "form_stage_main\\form_new_war_rule\\form_new_war_rule_killnum"
local SHUZITUPIAN = {
...
function refresh_killnum(kill_num)
  ...
  if kill_count < 0 then
    form = nx_execute("util_gui", "util_get_form", FORM_KILLNUM, false)
  else
    form = nx_execute("util_gui", "util_get_form", FORM_KILLNUM, true)
  end
  ...
  nx_execute("util_gui", "util_show_form", FORM_KILLNUM, true)
