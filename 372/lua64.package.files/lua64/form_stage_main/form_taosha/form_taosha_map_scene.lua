...
local FORM_PATH = "form_stage_main\\form_taosha\\form_taosha_map_scene"
local CTS_SUB_APEX_MSG_RELOAD_ICON = 11
...
function on_main_form_open(form)
  ...
  if flag_apex then
    nx_execute("custom_sender", "custom_apex", nx_int(CTS_SUB_APEX_MSG_RELOAD_ICON))
  end
end
