...
function get_sift_control(form)
  g_rbtn_table = {
    ...
    [20] = {
      control = form.rbtn_yyc,
      index = 20
    },
    [21] = {
      control = form.rbtn_city_zx,
      index = 21
    },
    [22] = {
      control = form.rbtn_city_yl,
      index = 22
    },
    [23] = {
      control = form.rbtn_city_gs,
      index = 23
    },
    [24] = {
      control = form.rbtn_city_jtg,
      index = 24
    }
  }
  local game_client = nx_value("game_client")
...
function set_sift_size(form)
  ...
  form.rbtn_yyc.Visible = false
  form.rbtn_city_zx.Visible = false
  form.rbtn_city_yl.Visible = false
  form.rbtn_city_gs.Visible = false
  form.rbtn_city_jtg.Visible = false
  local temp_table = {}
