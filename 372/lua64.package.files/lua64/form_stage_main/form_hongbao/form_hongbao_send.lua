...
function on_rbtn_channel_checked_changed(self)
  ...
  if self.Checked then
    ...
    chanel.DropListBox:AddString(nx_widestr(util_text("ui_hongbao_chanael_zongpai")))
    ...
    chanel.DropListBox:AddString(nx_widestr(util_text("ui_hongbao_chanael_lianmeng")))
