...
function on_main_form_close(form)
  nx_destroy(form)
  nx_set_value("form_stage_main\\form_relation\\form_relation_guild\\form_guild_bank_event", nx_null())
end
...
function on_get_guildbank_seetlement_list(...)
  local form = nx_value("form_stage_main\\form_relation\\form_relation_guild\\form_guild_bank_event")
