...
function on_main_form_close(form)
  nx_destroy(form)
  nx_set_value("form_stage_main\\form_relation\\form_relation_guild\\form_guild_bank_info", nx_null())
end
function init_guildbank_info(form)
  local form1 = nx_value("form_stage_main\\form_relation\\form_relation_guild\\form_guild_bank_info")
...
function get_guildbank_info(...)
  local form = nx_value("form_stage_main\\form_relation\\form_relation_guild\\form_guild_bank_info")
  if not nx_is_valid(form) then
    return
  end
...
function on_update_time(obj)
  ...
  local form = nx_value("form_stage_main\\form_relation\\form_relation_guild\\form_guild_bank_info")
  if not nx_is_valid(form) then
    form = nx_execute("util_gui", "util_get_form", "form_stage_main\\form_relation\\form_relation_guild\\form_guild_bank_info", true, false)
    nx_set_value("form_stage_main\\form_relation\\form_relation_guild\\form_guild_bank_info", form)
  end
