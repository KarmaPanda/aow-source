...
function set_visual_radius(scene, radius)
  ...
  if nx_is_valid(game_scene) then
    local scene_name = game_scene:QueryProp("Resource")
    if scene_name == "scene32" or scene_name == "groupscene044" then
      terrain.ClipRadiusNear = 100
      terrain.ClipRadiusFar = 500
    end
  end
