...
local FORM_PATH = "form_stage_main\\form_die_luandou"
...
function on_time_over()
  local flag = nx_execute("form_stage_main\\form_die_util", "IsInWuDaoYanWuScene")
  if flag then
    nx_execute("custom_sender", "custom_relive", RELIVE_TYPE_WUDAO_YANWU)
  else
    nx_execute("custom_sender", "custom_relive", RELIVE_TYPE_LUAN_DOU)
  end
end
