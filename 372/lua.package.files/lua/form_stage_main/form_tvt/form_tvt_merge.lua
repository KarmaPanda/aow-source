...
function show_join_tips(mltbox, type)
  local join_tips = {
    ...
    [SPECIAL_ITT_ANHEIBAPAI_D] = "@show_join_tips1017",
    [SPECIAL_ITT_ANHEIBAPAI_W] = "@show_join_tips1018",
    [SPECIAL_ITT_GUISHI_D] = "@show_join_tips1019",
    [SPECIAL_ITT_DUNRUYONGYE] = "@show_join_tips1020",
    [SPECIAL_ITT_TUNFENGJUEZHAN] = "@show_join_tips1021"
  }
...
function show_submit_tips(mltbox, type)
  local join_tips = {
    ...
    [SPECIAL_ITT_ANHEIBAPAI_D] = "@show_submit_tips1017",
    [SPECIAL_ITT_ANHEIBAPAI_W] = "@show_submit_tips1018",
    [SPECIAL_ITT_GUISHI_D] = "@show_submit_tips1019",
    [SPECIAL_ITT_DUNRUYONGYE] = "@show_submit_tips1020",
    [SPECIAL_ITT_TUNFENGJUEZHAN] = "@show_submit_tips1021"
  }
  local tips = join_tips[type]
  if tips == nil then
    return
...
function on_info_click(btn)
  ...
  if ITT_APEX == form.type or SPECIAL_ITT_TUNFENGJUEZHAN == form.type then
    util_show_form("form_stage_main\\form_war_scuffle\\form_balance_total", true)
  end
  if SPECIAL_ITT_ANHEIBAPAI_D == form.type or SPECIAL_ITT_ANHEIBAPAI_W == form.type or SPECIAL_ITT_GUISHI_D == form.type or SPECIAL_ITT_DUNRUYONGYE == form.type then
    util_show_form("form_stage_main\\form_night_forever\\form_night_forever", true)
  end
