...
local WuXing = {
  [0] = {
    desc = "jin",
    probarimage = "gui\\language\\ChineseS\\dfsj_zhujian\\mu_jindu.png"
  },
  [1] = {
    desc = "mu",
    probarimage = "gui\\language\\ChineseS\\dfsj_zhujian\\tu_jindu.png"
  },
  [2] = {
    desc = "shui",
    probarimage = "gui\\language\\ChineseS\\dfsj_zhujian\\huo_jindu.png"
  },
  [3] = {
    desc = "huo",
    probarimage = "gui\\language\\ChineseS\\dfsj_zhujian\\jin_jindu.png"
  },
  [4] = {
    desc = "tu",
    probarimage = "gui\\language\\ChineseS\\dfsj_zhujian\\shui_jindu.png"
  }
}
...
function on_main_form_open(self)
  ...
  self.Visible = true
  self.groupbox_disc.Visible = true
...
function refresh_form_pos(form)
  ...
  form.groupbox_disc.AbsLeft = (gui.Width - form.groupbox_disc.Width) / 6
  form.groupbox_disc.AbsTop = (gui.Height - form.groupbox_disc.Height) / 3
...
function change_form_size()
  local form = nx_value("form_stage_main\\form_small_game\\form_game_zhujian")
...
function set_probar_color(type)
  local form = nx_value("form_stage_main\\form_small_game\\form_game_zhujian")
  if not nx_is_valid(form) then
    return
  end
  form.pbar_sword.ProgressImage = WuXing[type].probarimage
end
...
function on_game_end(res)
  ...
  form.groupbox_disc.Visible = false
  ...
  timer:Register(2500, 1, "form_stage_main\\form_small_game\\form_game_zhujian", "auto_close_form", form, -1, -1)
end
function auto_close_form(self)
  local form = self
  if form == nil or not nx_is_valid(form) then
    form = nx_value("form_stage_main\\form_small_game\\form_game_zhujian")
  end
  if nx_is_valid(form) then
    ...
    nx_destroy(form)
    nx_set_value("form_stage_main\\form_small_game\\form_game_zhujian", nx_null())
  end
end
function on_btn_disc_click(btn)
...
function on_ani_end(self)
  ...
  if nx_is_valid(ShijiaEastZhujianGame) then
    ...
    do_action("interact585c")
    play_sound("sound_zhujian_rl_game", "snd\\action\\minigame\\zhujian\\dfsj_zj_lfx.wav")
  end
end
