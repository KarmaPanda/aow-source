...
local FORM_NAME = "form_stage_main\\form_sjy_shimen_rank"
...
function on_main_form_open(form)
  ...
  clear_grid(form)
  form.grid_info:SetColTitle(0, nx_widestr(util_text("ui_sjy_shimen_rank")))
  form.grid_info:SetColTitle(1, nx_widestr(util_text("ui_sjy_shimen_name")))
  form.grid_info:SetColTitle(2, nx_widestr(util_text("ui_sjy_shimen_kill_count")))
  nx_execute("custom_sender", "custom_send_sjy_shimen", 1)
  return
end
function close_form()
