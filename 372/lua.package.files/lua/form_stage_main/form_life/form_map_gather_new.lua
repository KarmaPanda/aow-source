...
function main_form_init(self)
  local form_gather = nx_value("form_stage_main\\form_life\\form_job_gather_new")
...
function on_groupmap_objs_click_obj(self, obj_type, lab_id, npc_type, x, y, z)
  local form = nx_value("form_stage_main\\form_life\\form_map_gather_new")
