...
function getReturnCityPosInfo()
  ...
  if not form_home_point:IsNewTerritoryType() then
    return
  end
  local relive_positon_name = "DongHaiRelivePositon"
...
function on_relive_check(ret)
  local form = util_get_form("form_stage_main\\form_die_donghai", false)
