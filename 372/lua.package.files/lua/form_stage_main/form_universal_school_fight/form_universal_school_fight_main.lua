...
function Update_War_Info(...)
  ...
  local is_can_join = arg[1]
  local defend_school = arg[2]
  local attack_school = arg[3]
  local defend_player_num = arg[4]
  local attack_player_num = arg[5]
  local fight_result = arg[6]
  local war_time = arg[7]
